...
if not exist %CAFFE2_ROOT%\build_64 mkdir %CAFFE2_ROOT%\build_64
cd %CAFFE2_ROOT%\build_64
...
rem cmake --build . --config %CMAKE_BUILD_TYPE% -- /maxcpucount:%NUMBER_OF_PROCESSORS% || goto :label_error
